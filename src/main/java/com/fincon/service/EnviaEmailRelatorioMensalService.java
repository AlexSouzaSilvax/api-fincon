...
@Service
public class EnviaEmailRelatorioMensalService {
    ...
    // @Scheduled(cron = "00 55 22 17 * ?", zone = "America/Sao_Paulo")
    public void enviaRelatorioMensal() {
        ...
        for (UserLancamentoMesAtualDTO usuario : usuarioService.findUserLancamentoMesAtual(pMesReferencia,
            ...
            String titulo = "Fincon - Relatório Mensal " + pMesReferenciaExtenso + "/" + pAnoReferencia;
    ...
    public String conteudoEmail(String pNomeUsuario, String pMesReferenciaExtenso, int pAnoReferencia) {
        return "<!DOCTYPE html>\n" +
                ...
                "        <br />\n" +
                "        <p>Seu relatório do mês de " + pMesReferenciaExtenso + " de " + pAnoReferencia
                + " já está pronto.</p>\n" +
                "        <br />        \n" +
                "        <br />\n" +
                "        <br />\n" +
